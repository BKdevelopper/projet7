      ...
      <form className="formulaire" onSubmit={handleLogin} >
          ...
          <div className="container-login_form">
            <div className="container-login_form_username">
              <label htmlFor="username" className="container-login_form_username_texte">Username</label>
              <input
                type="text"
                name="username"
            ...
            <div className="container-login_form_password">
              <label htmlFor="password" className="container-login_form_password_texte">Password</label>
              <input
                type="password"
                name="password"
                id="password"
            ...
            <div className="container-login_form_btn">
              <input type="submit" className="container-login_form_btn_login" value="Se connecter"/>
              <NavLink className="container-login_form_btn_register" to="/register">
                 Inscription                    
              </NavLink>
            </div>
          </div>
